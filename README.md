...
**本專案的核心願景，即是「弭平醫療差距，讓 AI 賦能基層」。**

我們利用 **SMART on FHIR** 國際標準作為溝通橋樑，將臺大醫院訓練成熟的 **AI 影像判讀模型**（如：糖尿病視網膜病變偵測）透過標準化介面分享給合作的基層診所。診所醫師無需投入高昂成本建置運算設備，僅需透過此輕量化平台，即可即時取得醫學中心等級的 AI 輔助判讀建議。
